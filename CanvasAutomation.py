...
from automationGUI import RequiredInput, Options, ModeButtons, RunButtons, SingleUpdateInput, MultiUpdateInput
...
class App:
    def __init__(self, root):
        ...
        options_lf.pack(fill=X, expand=YES, anchor=N, pady=(15,0))
        ...
        self.run_buttons = RunButtons(run_button_row, self.root, self, self.mode_buttons, self.required_input, self.options_input, self.single_update_input, self.multi_update_input)
